...
async function seedDatabase() {
  ...
  const CREATE_AUTHOR_PAPER_TABLE = `
    ...
    const authors = [
        ...
        //   {
        //       author_name: 'David Colognori',
        //       university: 'Oxford',
        //       date_of_birth: '1992-04-26',
        //       h_index: 12,
        //       gender: 'm',
        //       mentor_name: 'Johnny T Y Kung'
        //   },
        //   {
        //     author_name: 'Jeannie T Lee',
        //     university: 'Oxford',
    ...
    const researchPapers = [
        {
            paper_title: 'Electronic Textile Sensors for Decoding Vital Body Signals: State-of-the-Art Review on Characterizations and Recommendations',
            conference: '',
            publish_date: '2022-01-13',
        },
        {
            paper_title: 'Social Influence Leads to the Formation of Diverse Local Trends',
            conference: '',
            publish_date: '2021-10-22',
        },
        {
            paper_title: 'A COMPARISON OF LATIN AMERICAN AND ASIAN PRODUCT EXPORTS TO THE UNITED STATES, 1972 TO 1999',
        ...
        {
            paper_title: 'Associative Diffusion and the Pitfalls of Structural Reductionism',
            conference: 'American Sociological',
            publish_date: '2021-11-19',
        },
        {
            paper_title: 'Capitalism, Laws, and the Need for Trustworthy Institutions',
        ...
        {
            paper_title: 'On-Body Energy Harvesters through Innovative Designs and Conformable Structures',
            conference: '',
            publish_date: '2021-11-04',
        },
        {
            paper_title: 'Simultaneous Recording, Stimulation, and Marking of Brain Microstructures',
            conference: '',
        ...
        {
            paper_title: 'Association between COVID-19 Outcomes and Mask Mandates, Adherence, and Attitudes',
            conference: '',
        ...
        {
            paper_title: 'Collective Behavior over Social Networks with Data-driven and Machine Learning Models',
            conference: '',
        ...
        {
            paper_title: 'The Three Stages of Disruptive Innovation: Idea Generation, Incubation, and Scaling',
            conference: '',
            publish_date: '2019-05-01',
        },
        {
            paper_title: 'How leadership matters: The effects of leadership on strategy implementation',
            conference: '',
        ...
        {
            paper_title: 'Design and preliminary results of a reaction force series elastic actuator for bionic knee and ankle prostheses',
            conference: '',
            publish_date: '2021-07-21',
        },
        {
            paper_title: 'Neural Interfacing Architecture Enables Enhanced Motor Control and Residual Limb Functionality Post Amputation',
            conference: '',
            publish_date: '2021-02-15',
        },
        {
            paper_title: 'Flexible Dry Electrodes for EMG Acquisition within Lower Extremity Prosthetic Sockets',
            conference: '',
            publish_date: '2020-11-29',
        },
        {
            paper_title: 'Design and control of a Two-Degree-of-Freedom powered ankle-foot prosthesis',
            conference: '',
            publish_date: '2020-09-09',
        },
        {
            paper_title: 'Coordination of Lower Limb Movement Utilizing the Agonist-Antagonist Myoneural Interface',
            conference: '',
            publish_date: '2019-08-09',
        },
        {
            paper_title: 'MultiDIC: An Open-Source Toolbox for Multi-View 3D Digital Image Correlation',
            conference: '',
            publish_date: '2018-05-04',
        },
        {
            paper_title: 'Human Leg Model Predicts Muscle Forces, States, and Energetics during Walking',
            conference: '',
